...
Usage: python3 denoise_videos.py <folder-or-file> [output_folder-or-file] [--mbps MBPS | --crf CRF] [--overwrite]
...
def run(input_path: Path, output: Path | None, mbps: float | None, crf: float | None,
        overwrite: bool) -> None:
...
def main() -> None:
    ...
    run(input_path, output, args.mbps, args.crf, args.overwrite)
